...
const SEED_DATA = {
  "projects": [
    {
      ...
      "latestWork": "feat(site-manager): add /verify command and post-deploy verification (v1.3.0).feat(site-manager): add verify.py deployment verification script.fix(site-manager): dark theme for main site login and register templates.",
      ...
      "latestCommits": [
        ...
        {
          "hash": "78e4769",
          "message": "fix(site-manager): dark theme for main site login and register templates"
        },
        {
          "hash": "2035c32",
          "message": "fix(site-manager): wire OAuth routes in app.ts and add login buttons"
        },
        {
          "hash": "2908148",
          "message": "feat(site-manager): add /update command, displayName in manifest"
        }
      ]
    },
    {
    ...
    },
    {
      ...
      "modifiedFiles": [
        ...
        },
        {
          "path": "README.md",
          "change": "modified",
          "summary": "+2/-2 — changed: git clone <repo-url> ~/projects/personal/mysetup"
        },
        {
    ...
    },
    {
      ...
      "uncommittedDetail": "7 changed files",
      "openBranches": [],
      "latestWork": "feat: project management dashboard with dev-team aesthetic.",
      ...
      "modifiedFiles": [
        {
          "path": "index.html",
          "change": "modified",
          "summary": "+352/-152 — changed: .indicator-row {"
        },
        {
          "path": "scan-projects.sh",
          "change": "modified",
          "summary": "+65/-20 — changed: sed 's/[\",:]//g' | \\"
        },
        {
          "path": "seed-data.js",
          "change": "modified",
          "summary": "+3425/-401 — changed: * Auto-updated by server refresh."
        },
        {
          "path": "scan-branches.py",
          "change": "untracked",
          "summary": "2KB — usr/bin/env python3"
        },
        {
          "path": "scan-modified.py",
          "change": "untracked",
          "summary": "4KB — usr/bin/env python3"
        },
        {
          "path": "server.js",
          "change": "untracked",
          "summary": "5KB — const http = require('http');"
        },
        {
          "path": "start.sh",
          "change": "untracked",
          "summary": "458B — bin/bash"
        }
      ],
      "branchDetails": [],
      "stagedCount": 0,
    ...
    },
    {
      ...
      "uncommittedDetail": "1 changed files",
      "openBranches": [
        "feature/cookbook-project-format",
        "feature/ingredient-recipe-concoction",
        "feature/move-site-design-rule",
        "feature/platform-guidelines-reorg",
        "feature/prefer-explicit-apple-apis",
        "feature/reclassify-recipes",
        "feature/support-automation-principle",
        "feature/yolo-deny-askuserquestion",
        "fix/worktree-cd-rule",
        "revise/prefer-explicit-apple-apis"
      ],
      "latestWork": "Reclassify recipes into ingredients and update sibling projects (#43).Add ingredient/recipe/concoction artifact hierarchy (#42).Add skill test harness with Vitest + Claude CLI (#41).",
      "runCmd": "",
      "tags": [
        "agentic-cookbook",
        "documentation"
      ...
      "modifiedFiles": [
        {
          "path": ".claude/CLAUDE.md",
          "change": "modified",
          "summary": "+1/-1 — changed: **Owner edits** go direct to main. **Claude Code sessions** "
        }
      ],
      "branchDetails": [
        {
          "name": "feature/cookbook-project-format",
          "commits": [
            {
              "hash": "c1dfdad",
              "message": "Allow $schema field in cookbook-project.json schema"
            },
            {
              "hash": "eb816f6",
              "message": "Add example cookbook project (document editor)"
            },
            {
              "hash": "1392f68",
              "message": "Add JSON Schema for cookbook-project.json"
            },
            {
              "hash": "5cac052",
              "message": "Add cookbook project format decision record"
            },
            {
              "hash": "2e156dc",
              "message": "Initial empty commit for cookbook project format"
            }
          ],
          "summary": "5 commits — Allow $schema field in cookbook-project.json schema",
          "commitCount": 5
        },
        {
          "name": "feature/ingredient-recipe-concoction",
          "commits": [
            {
              "hash": "40fa2fe",
              "message": "Update compliance indexes for ingredient and concoction formatting"
            },
            {
              "hash": "003eed4",
              "message": "Add decision record for ingredient/recipe/concoction hierarchy"
            },
            {
              "hash": "199d1f0",
              "message": "Update conventions, glossary, documentation, and rules for ingredient/recipe/concoction hierarchy"
            },
            {
              "hash": "991b169",
              "message": "Add concoction schema, compliance checks, and updated example"
            },
            {
              "hash": "fd594d0",
              "message": "Redefine recipe format as ingredient composition with integration focus"
            },
            {
              "hash": "b85a6df",
              "message": "Add ingredient artifact format: template and compliance checks"
            },
            {
              "hash": "0fae2cf",
              "message": "chore: initialize ingredient/recipe/concoction hierarchy branch"
            }
          ],
          "summary": "7 commits — Update compliance indexes for ingredient and concoction formatting",
          "commitCount": 7
        },
        {
          "name": "feature/move-site-design-rule",
          "commits": [
            {
              "hash": "70bd113",
              "message": "Remove site-design rule and stale gitignore entries"
            },
            {
              "hash": "ff87a42",
              "message": "chore: move site-design rule to agentic-cookbook-web"
            }
          ],
          "summary": "2 commits — Remove site-design rule and stale gitignore entries",
          "commitCount": 2
        },
        {
          "name": "feature/platform-guidelines-reorg",
          "commits": [
            {
              "hash": "6e36031",
              "message": "Update index.md with reorganized platform guidelines section"
            },
            {
              "hash": "0b4a7e3",
              "message": "Add cross-platform system integration guidelines"
            },
            {
              "hash": "3e2c100",
              "message": "Move deep-linking and shortcuts-and-automation from ui/ to platform/"
            },
            {
              "hash": "e13b102",
              "message": "Initial empty commit for draft PR"
            }
          ],
          "summary": "4 commits — Update index.md with reorganized platform guidelines section",
          "commitCount": 4
        },
        {
          "name": "feature/prefer-explicit-apple-apis",
          "commits": [
            {
              "hash": "8b284c8",
              "message": "Add guideline: prefer explicit Apple APIs for agentic development"
            },
            {
              "hash": "018875c",
              "message": "Initial empty commit for draft PR"
          ...
          "summary": "2 commits — Add guideline: prefer explicit Apple APIs for agentic development",
          "commitCount": 2
        },
        {
          "name": "feature/reclassify-recipes",
          "commits": [
            {
              "hash": "b026638",
              "message": "Update indexes, cross-references, and documentation counts after reclassification"
            },
            {
              "hash": "889f7e3",
              "message": "Move 18 atomic specs from recipes/ to ingredients/ with updated frontmatter and cross-references"
            },
            {
              "hash": "86fdfdc",
              "message": "chore: initialize recipe reclassification branch"
            }
          ],
          "summary": "3 commits — Update indexes, cross-references, and documentation counts after reclassification",
          "commitCount": 3
        },
        {
          "name": "feature/support-automation-principle",
          "commits": [
            {
              "hash": "ab55a89",
              "message": "Add Support Automation principle"
            },
            {
              "hash": "70afab5",
              "message": "Initial empty commit for draft PR"
          ...
          "summary": "2 commits — Add Support Automation principle",
          "commitCount": 2
        },
        {
          "name": "feature/yolo-deny-askuserquestion",
          "commits": [
            {
              "hash": "5d8c208",
              "message": "Add AskUserQuestion to YOLO deny defaults"
            },
            {
              "hash": "ff50d98",
              "message": "chore: add AskUserQuestion to YOLO deny defaults"
            }
          ],
          "summary": "2 commits — Add AskUserQuestion to YOLO deny defaults",
          "commitCount": 2
        },
        {
          "name": "fix/worktree-cd-rule",
          "commits": [
            {
              "hash": "1e31710",
              "message": "Forbid cd chaining as substitute for persistent cd in worktree rule"
            },
            {
              "hash": "042e647",
              "message": "fix: clarify worktree cd requirement"
            }
          ],
          "summary": "2 commits — Forbid cd chaining as substitute for persistent cd in worktree rule",
          "commitCount": 2
        },
        {
          "name": "revise/prefer-explicit-apple-apis",
          "commits": [
            {
              "hash": "d8483a8",
              "message": "Strengthen guideline: use AppKit/UIKit, SwiftUI only when required"
            },
            {
              "hash": "aa89974",
              "message": "Initial empty commit for draft PR"
          ...
          "summary": "2 commits — Strengthen guideline: use AppKit/UIKit, SwiftUI only when required",
          "commitCount": 2
        }
      ],
      "stagedCount": 0,
      ...
      "latestCommits": [
        ...
        {
          "hash": "f52c333",
          "message": "Add artifact skills, rules, and compliance formatting (#39)"
        }
      ]
    },
    {
    ...
    },
    {
      ...
      "openBranches": [],
      "latestWork": "Update remaining command references in planning docs.Update command references in planning docs: project → recipe.Replace command names: create-project-from-code → create-recipe-from-code, create-code-from-project → create-code-from-recipe, view-project → view-recipe.",
      "runCmd": "",
      "tags": [
        "agentic-cookbook",
        "ai",
      ...
      "modifiedFiles": [
        {
          "path": "plugins/dev-team/agents/artifact-reviewer.md",
          "change": "modified",
          "summary": "+4/-3 — changed: description: Reviews any Claude Code artifact (skill, rule, "
        },
        {
          "path": "plugins/dev-team/agents/project-assembler.md",
          "change": "modified",
          "summary": "+37/-37 — changed: description: Builds a concoction.json manifest and scaffolds"
        },
        {
          "path": "plugins/dev-team/agents/recipe-writer.md",
          "change": "modified",
          "summary": "+3/-3 — changed: description: Writes a cookbook ingredient spec from source c"
        },
        {
          "path": "plugins/dev-team/skills/dev-team/workflows/lint.md",
          "change": "modified",
          "summary": "+10/-9 — changed: You are **the Linter** — you evaluate Claude Code artifacts "
        }
      ],
      "branchDetails": [],
      "stagedCount": 0,
      ...
      "latestCommits": [
        {
          "hash": "8ef816c",
          "message": "Update remaining command references in planning docs"
        },
        {
          "hash": "4b3229e",
          "message": "Update command references in planning docs: project → recipe"
        },
        {
          "hash": "75f6d43",
          "message": "Replace command names: create-project-from-code → create-recipe-from-code, create-code-from-project → create-code-from-recipe, view-project → view-recipe"
        },
        {
          "hash": "f1d54f0",
          "message": "Update command names in architecture.md"
        },
        {
          "hash": "01f18fe",
          "message": "Update specialist-guide.md: rename commands to recipe-based naming"
        }
      ]
    },
    {
  ...
  "todos": [
    ...
    {
      "id": "auto-dev-team-tests-uncommitted",
      "projectId": "dev-team-tests",
