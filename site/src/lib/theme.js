...
export function todoCardClass(priority) {
...
export function issueCardClass(severity) {
...
export function todoPillClass(priority) {
...
export function issuePillClass(severity) {
...
export function navBadgeClass(colorKey) {
