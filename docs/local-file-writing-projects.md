...
- **Path**: `~/projects/active/social-media-bot/`
...
- **Outputs**:
  - SQLite database: `~/projects/active/social-media-bot/data/social-media-bot.db` (bot_runs, drafts, posts, metrics)
  - Draft files: `~/projects/active/social-media-bot/data/drafts/`
  - Research artifacts: `~/projects/active/social-media-bot/data/research/`
...
| `~/projects/active/social-media-bot/data/` | Bot DB + drafts + research | Social Media Bot |
